    ...
    <div>
      ...
      {step === 3 && (
        <PageTitle
          ...
          subtitle={
            'Será feita uma reserva, mas o valor só será descontado quando você comfirmar a presença do(a) diarista'
          }
        />
      )}
      <UserFormContainer>
        <PageFormContainer fullWidth={step === 4}>
          <Paper sx={{ p: 4 }}>
            ...
            {step === 3 && (
              <FormProvider {...paymnetForm}>
                <form onSubmit={paymnetForm.handleSubmit(onPaymentFormSubmit)}>
